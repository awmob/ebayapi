<?php
	...
	//HTTP System
/*	define('ROOT', 'http://127.0.0.1/soldsmart/ADWORDS/');//change this to your server details
	define('HTTPS_ROOT', 'https://127.0.0.1/soldsmart/ADWORDS/');//change this to your server details
*/
	...
	//define('FILE_SYSTEM_MAIN', FILE_SYSTEM_ROOT . 'soldsmart/ADWORDS/'); //change this to your server details
	...
	define('EBAY_API_FILESYSTEM_CONFIG', EBAY_API_FILESYSTEM_INCLUDES . 'config.inc.php');
...
*/
	...
	define('DS_TYPE_BDIRECT',"6");
	define('DS_TYPE_TRINITY',"7");
	define('DS_TYPE_SIMPLYWHOLESALE',"8");
	define('DS_TYPE_DRCARL',"9");
