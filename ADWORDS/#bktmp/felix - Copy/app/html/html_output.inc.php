	...
	Class html_output{
		...
		*/
		...
		public function headermain($title){
			$display = "<html><head><title>".$title."</title><link rel='stylesheet' type='text/css' href='stylesheets/style.css'></head><body>";
			...
			$display = "<div class='rightmenu'>";
				...
				for ($i=0; $i < sizeof($newsarray)  ;$i++){
					$display .= "<div class='newshow'>";
						...
						$display .= "<p><b>".$newsarray[$i]['date']."</b></p>";
						$display .= "<p>".$newsarray[$i]['news']."</p>";
