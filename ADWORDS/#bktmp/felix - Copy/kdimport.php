			...
			//show imports
				...
				if ($_GET['import'] == 99){
					...
					$display .= "<div class='newshow'>";
						...
						$pagedr[6][1] = DS_RP_SIMPLY_FILE_HTTP;
						...
						if (!$error_main){
							if ($ds == DS_TYPE_UNITEX){
								...
								if($error[0]){
									...
									$display .= "<p>Download the Rapid Publisher file <a href='".DS_RP_SIMPLY_FILE_HTTP."'>HERE</a>. You then need to upload the feed to the Onescent FTP SoldSmartUse folder.</p>";
